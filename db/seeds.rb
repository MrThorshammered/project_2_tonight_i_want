...
r2 = Recipe.create!(name:'Full Irish', method:'cook ingredients', image:'https://dbsirishstudies.files.wordpress.com/2013/07/real-full-iris-breakfast1.jpg', country_id:c2.id)
r3 = Recipe.create!(name:'korma', method:'cook ingredients', image:'http://realfood.tesco.com/media/images/085797-HERO-93966f43-758c-469e-b8d3-b884c134b974-0-472x310.jpg', country_id:c3.id)
r4 = Recipe.create!(name:'sweet and sour hong kong style', method:'cook ingredients', image:'http://www.goldencitycrawley.co.uk/images/sweet&sour3.jpg', country_id:c4.id)
